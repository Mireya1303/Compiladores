...
public class Primero {
    ...
    public String resultados() {
        ...
        this.primeros.forEach((noTerminal, conjunto) -> {
            ...
            builder.append(
                "PRIMERO(").append(noTerminal).append(") = ").append(conjunto);
            builder.append("\n");
        });
        System.out.println();
        builder.append( "\n" );
    ...
    private void construirValoresM(GSVicio gSVicio) {
        for (String noTerminal : gSVicio.getNoTerminales()) {
            ...
            ArrayList<String> producciones = 
                    gSVicio.getProducciones().get(noTerminal);
    ...
    private void agregarValorM(GSVicio gSVicio, String noTerminal, 
            String produccion, Set<String> B) {
        ArrayList<String> producciones = 
                gSVicio.getProducciones().get(noTerminal);
        for (String prod : producciones) {
