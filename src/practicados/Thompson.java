...
/**
 *
 * Esta clase implementa los algoritmos de Thompson para cada uno de los 
 * operadores de una expresion regular.<br>
 * 
 * Las operaciones implementadas en esta clase tiene de efectos secundarios 
 * (side-effects) sobre los AFN recibidos como argumentos ya que en ciertos 
 * casos estos resultan alterados. Sin embargo, a efectos practicos esto no es 
 * un problema, ya que en la traduccion de una expresion regular a AFN siempre 
 * sera significativo solo el ultimo AFN construido.<br>
 * 
 * La solucion que podria aplicarse para corregir este efecto es implementar 
 * una funcion de copia para los AFN.
 * 
 * @author kdelaof
 */
public class Thompson {
     ...
     */
    public AFN basico(String simbolo) {
        AFN afn = new AFN();
     ...
     * 
     * @return El AFN resultante de aplicar cerradura de Kleene a 
     * afn.
     */
    public AFN cerraduraKleene(AFN afn) {
         ...
         */
        AutomataFinito.copiarEstados(
                afn, afn_salida, afn_salida.cantidadEstados());
        ...
        nuevoInicio.getTransiciones().agregar(
                new Transicion(afn_salida.getEstado(1), Alfabeto.VACIO));
        nuevoInicio.getTransiciones().agregar(
                new Transicion(nuevoFin, Alfabeto.VACIO));
       
        /* Estado anterior al final */
        Estado antesDeFinal = 
                afn_salida.getEstado(afn_salida.cantidadEstados() - 2);
     ...
     */
    public AFN cerraduraPositiva(AFN afn) {
    ...
    public AFN union(AFN afn1, AFN afn2) {
         ...
         * a la cantidad de estado en el AFN destino.
         */
        AutomataFinito.copiarEstados(afn1, afn, afn.cantidadEstados());
       
        /*
         * Agregamos los estados de afn2, el incremento es igual
         * a la cantidad de estado en el AFN destino.
         */
        AutomataFinito.copiarEstados(afn2, afn, afn.cantidadEstados());
        ...
        trans.setSimbolo(Alfabeto.VACIO);
        afn.getEstado(
                afn.cantidadEstados() - 2).getTransiciones().agregar(trans);
    ...
    public AFN concatenacion(AFN afn1, AFN afn2) {
         ...
         */
        AutomataFinito.copiarEstados(afn2, afn, afn.cantidadEstados() - 1, 1);
         ...
         */
        AutomataFinito.copiarTransiciones(afn, inicioAfn2.getTransiciones(),
