...
public class Minimizacion {
     ...
     * @return Un AFD equivalente a afd pero con la menor cantidad de estados
     * posibles.
     */
     ...
     *
     * @param afd El AFD cuyos estados alcanzados deben ser recuperados.
     ...
     * @return Un AFD equivalente pero con menos estados.
     */
    private static AFD minimizar(AFD afd) {
        ...
        while (true) {
            ...
            for (Conjunto<Estado> grupo : particion) {
                if (grupo.cantidad() == 0) {
                    ...
                    /*
                     * Los grupos unitarios se agregan directamente, debido 
                    ...
                    tabla2 = new Hashtable<
                                Conjunto<Integer>, Conjunto<Estado>>();
                    for (Estado e : grupo) {
            ...
            /*
             * Paso 2.4: ========= Si las particiones son iguales, significa 
             * que no hubo cambios y debemos terminar. En caso contrario, 
        ...
        /*
         * Paso 3: ======= Debemos crear el nuevo AFD, con los nuevos 
         * estados producidos.
         */
        AFD afdPostMinimizacion
                = new AFD(afd.getAlfabeto(), afd.getExprReg());

        /*
         * Paso 3.1: ========= Agregamos los estados al nuevo AFD. Para los
         * estados agrupados, colocamos una etiqueta distintiva, para que 
         * pueda notarse resultado de cuales estados es.
         */
        for (int i = 0; i < particion.cantidad(); i++) {
            ...
            /*
             * El grupo actual tiene un estado final, el estado 
             * correspondiente
            ...
            /*
             * Si el estado es resultado de la union de dos o mas estados, 
             * su etiqueta sera del tipo e1.e2.e3, donde e1, e2 y e3 son los
        ...
        /*
         * Paso 3.2: ========= Generamos un mapeo de grupos (estados del 
         * nuevo AFD) a estados del AFD original, de manera a que resulte 
         * sencillo obtener los estados adecuados en el momento de agregar 
         * las transiciones al nuevo AFD.
         */
    ...
    private static Conjunto<Integer> getGruposAlcanzados(Estado origen,
         ...
         * colocamos null.
         */
        HashMap<String, Estado> transiciones = 
                origen.getTransicionesSegunAlfabeto(alfabeto);
     ...
     *
     * @param origen El automata origen.
     * @param destino El automata destino.
     */
    private static void copiarAutomata(AutomataFinito origen, 
            AutomataFinito destino) {
        /* Copiamos los estados y transiciones */
        AutomataFinito.copiarEstados(origen, destino, 0);
     ...
     * @return true si el grupo de estados contiene un estados final, false en
     * caso contrario.
     */
    ...
    private static String obtenerEtiqueta(Conjunto<Estado> grupo) {
        ...
        for (Estado e : grupo) {
            ...
            } else if (e.toString().endsWith("i") || 
                    e.toString().endsWith("f")) {
     ...
     *
     * @return El Log correspondiente al algoritmo de minimizacion.
     */
