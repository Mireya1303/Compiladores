...
public class Estado implements Comparable<Estado> {
     ...
     * @param alfabeto El Alfabeto sobre el cual buscar 
     * transiciones en el Estado.
     * @return Un Hashtable que contiene el Estado
     * alcanzado para cada simbolo de alfabeto. Si no existe 
     * transicion para un simbolo dado, el valor sera igual a 
     * null.
     */
    public HashMap<String, Estado> getTransicionesSegunAlfabeto(
            Alfabeto [] alfabeto) {
        HashMap<String, Estado> trans = new HashMap<String, Estado>();
       
        /* Rellenamos todo con null */
        for (Alfabeto s : alfabeto)
            trans.put(s.toString(), null);
    ...
    public HashMap<String, Estado> getTransicionesSegunAlfabeto(
        ...
        /* Rellenamos todo con null */
//        for (String s : alfabeto.toString() )
//            trans.put(s.toString(), null);
